<?php $__env->startSection('title', 'ICA - Admin Login'); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- Register Button -->
            <a href="<?php echo e(route('register')); ?>" class="btn-auth-outline">
                <i class="fas fa-user-plus me-2"></i>Buat Akun Baru
            </a>

            <!-- Links Section -->
            <div class="auth-links">
                <a href="<?php echo e(route('admin.password.request')); ?>" class="auth-link">
...
<?php echo $__env->make('layouts.admin-auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ICA-LANDING_PAGE\landing-page\resources\views/auth/admin-login.blade.php ENDPATH**/ ?>