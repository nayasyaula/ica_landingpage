        ...
        <div class="col-12 col-lg-8 col-xl-6">
            ...
            <div class="admin-table-card">
                ...
                <div class="card-body-luxury p-4">
                    <form action="<?php echo e(route('admin.sponsors.store')); ?>" method="POST" enctype="multipart/form-data" id="sponsorForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="platinum" <?php echo e(old('tier') == 'platinum' ? 'selected' : ''); ?> data-color="bg-light text-dark">
                                    Platinum
                                </option>
                                <option value="gold" <?php echo e(old('tier') == 'gold' ? 'selected' : ''); ?> data-color="bg-warning text-dark">
                                    Gold
                                </option>
                                <option value="silver" <?php echo e(old('tier') == 'silver' ? 'selected' : ''); ?> data-color="bg-secondary">
                                    Silver
                                </option>
                                <option value="bronze" <?php echo e(old('tier') == 'bronze' ? 'selected' : ''); ?> data-color="bg-danger">
                                    Bronze
                                </option>
                            </select>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ica_landingpage\resources\views\admin\sponsors\create.blade.php ENDPATH**/ ?>