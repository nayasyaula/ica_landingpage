...
unset($__errorArgs, $__bag); ?>
                                ...
                                <!-- Custom Dropdown -->
                                <div class="form-group">
                                    <label class="form-label luxury-heading text-white mb-2 block">Jabatan / Posisi</label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group" id="otherPositionField" style="display: none;">
                                    <label for="other_position" class="form-label luxury-heading text-white mb-2 block">Jabatan Lainnya</label>
                                    <div class="relative">
