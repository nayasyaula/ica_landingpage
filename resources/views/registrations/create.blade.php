...
@section('content')
<section class="min-h-screen py-20 gold-pattern flex items-center justify-center">
    <div class="max-w-7xl mx-auto px-4 w-full">
        <div class="flex justify-center">
            <div class="w-full max-w-2xl">
                <!-- Header Section -->
                <div class="text-center mb-12">
                    <h2 class="section-title text-4xl md:text-5xl text-white mb-4">Event Registration</h2>
                    <p class="text-xl text-gray-300 luxury-text">
                        Complete your registration for the exclusive event
                    </p>
                </div>
                ...
                <div class="card-luxury rounded-xl mb-8">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="bg-gold-400 text-black px-4 py-2 rounded-full text-sm font-semibold">
                                {{ $event->available_slots }}/{{ $event->capacity }} Available
                            </span>
                        </div>
                ...
                <div class="card-luxury rounded-xl">
                    <div class="p-1 bg-gradient-to-r from-gold-400 to-gold-600 rounded-xl">
                        <div class="bg-dark-gray p-8 rounded-xl">
                            <div class="mb-6">
                                <h3 class="text-2xl font-bold text-white luxury-heading mb-2">Registration Form</h3>
                                <p class="text-gray-300 luxury-text">Please fill in your details accurately</p>
                            </div>
                            ...
                            <form method="POST" action="{{ route('registrations.store', $event) }}" class="space-y-6">
                                ...
                                <div class="form-group">
                                    <label for="name" class="form-label luxury-heading text-white mb-2 block">Full Name</label>
                                    <div class="relative">
                                ...
                                <!-- Email Field -->
                                <div class="form-group">
                                    <label for="email" class="form-label luxury-heading text-white mb-2 block">Email Address</label>
                                    <div class="relative">
                                ...
                                <!-- Phone Field -->
                                <div class="form-group">
                                    <label for="phone" class="form-label luxury-heading text-white mb-2 block">Phone Number</label>
                                    <div class="relative">
                                ...
                                <!-- Additional Notes -->
                                <div class="bg-gold-400 bg-opacity-10 border border-gold-400 border-opacity-30 rounded-lg p-4">
                                    <div class="flex items-start">
                                        <i class="fas fa-info-circle text-gold-400 mr-3 mt-1"></i>
                                        <div>
                                            <p class="text-gold-300 luxury-text text-sm">
                                                Your registration details will be verified. Please ensure all information is accurate. 
                                ...
                                <div class="flex flex-col sm:flex-row gap-4 pt-4">
                                    <button type="submit" 
                                        ...
                                        <i class="fas fa-paper-plane mr-2"></i> Complete Registration
                                    </button>
                                    <a href="{{ url()->previous() }}" 
                                       class="border border-gold-400 text-gold-400 px-8 py-4 rounded-lg font-semibold text-center hover:bg-gold-400 hover:text-black transition-colors">
